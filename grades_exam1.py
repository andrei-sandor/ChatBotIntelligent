...
joblib.dump(model_linear_regression, 'regression_model_grade1.joblib')
...
joblib.dump(model_dnn, 'model_dnn_grade1.joblib')
...
joblib.dump(model_dnn2, 'model_dnn2_grade1.joblib')
